...
SolarSystem::SolarSystem()
	...
	solarSystemBalls[1] = new Ball(1, 0.244f, QVector3D(38.0f * SEMI_AXIS_SCALE * 1.5f, 0.0f, 0.0f), 360.0f / 87.70f, 360.0f / 58.653f, 0.01f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[1]->textureBind(":/resource/textures/mercury.jpg");

	// Venus r = 6052km 0.72 224.701 -243.02 2.64
	solarSystemBalls[2] = new Ball(2, 0.6052f, QVector3D(72.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 224.701f, -360.0f / 243.02f, 2.64f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[2]->textureBind(":/resource/textures/venus.jpg");

	// Earth r = 6378km 1.00 365.2422 0.9973 23.44
	solarSystemBalls[3] = new Ball(3, 0.6378f, QVector3D(100.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 365.2422f, 360.0f / 0.9973f, 23.44f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[3]->textureBind(":/resource/textures/earth.jpg");

	// Moon r = 1737km
	solarSystemBalls[9] = new Ball(9, 0.1737f, QVector3D(100.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 365.2422f, 360.0f / 27.35f, 23.44f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[9]->textureBind(":/resource/textures/moon.jpg");

	// Mars r = 3398km 1.52 686.98 1.026 25.19
	solarSystemBalls[4] = new Ball(4, 0.3398f, QVector3D(152.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 686.98f, 360.0f / 1.026f, 25.19f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[4]->textureBind(":/resource/textures/mars.jpg");

	// Jupiter r = 71492km 5.20 4332.59 0.42 3.12 // 缩短距离
	solarSystemBalls[5] = new Ball(5, 7.1492f, QVector3D(320.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 4332.59f, 360.0f / 0.42f, 3.12f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[5]->textureBind(":/resource/textures/jupiter.jpg");

	// Saturn r = 60268km 9.54 10759 0.45 26.73
	solarSystemBalls[6] = new Ball(6, 6.0268f, QVector3D(454.0f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 10759.0f, 360.0f / 0.45f, 26.73f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
	solarSystemBalls[6]->textureBind(":/resource/textures/saturn.jpg");

	// Uranus r = 25559km 19.218 30799.095 -0.719 82.23
	solarSystemBalls[7] = new Ball(7, 2.5559f, QVector3D(621.8f * SEMI_AXIS_SCALE, 0.0f, 0.0f), 360.0f / 30799.095f, 360.0f / -0.719f, 82.23f, PLANET_SHININESS, PLANET_AMBI, PLANET_DIFF, PLANET_SPEC, 1.0f);
